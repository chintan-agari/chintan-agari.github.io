...
var pt = (r, t, e) => t in r ? ut(r, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : r[t] = e;
 ...
 */
var R;
const N = window, J = N.trustedTypes, ft = J ? J.emptyScript : "", K = N.reactiveElementPolyfillSupport, j = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? ft : null;
      break;
...
g[z] = !0, g.elementProperties = /* @__PURE__ */ new Map(), g.elementStyles = [], g.shadowRootOptions = { mode: "open" }, K == null || K({ ReactiveElement: g }), ((R = N.reactiveElementVersions) !== null && R !== void 0 ? R : N.reactiveElementVersions = []).push("1.6.3");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var k;
const T = window, y = T.trustedTypes, F = y ? y.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, D = "$lit$", v = `lit$${(Math.random() + "").slice(9)}$`, ot = "?" + v, At = `<${ot}>`, A = document, C = () => A.createComment(""), w = (r) => r === null || typeof r != "object" && typeof r != "function", lt = Array.isArray, gt = (r) => lt(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", L = `[ 	
\f\r]`, b = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, G = /-->/g, Q = />/g, _ = RegExp(`>|${L}(?:([^\\s"'>=/]+)(${L}*=${L}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), X = /'/g, Y = /"/g, ht = /^(?:script|style|textarea|title)$/i, yt = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), tt = yt(1), m = Symbol.for("lit-noChange"), u = Symbol.for("lit-nothing"), et = /* @__PURE__ */ new WeakMap(), f = A.createTreeWalker(A, 129, null, !1);
function at(r, t) {
...
const mt = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    const l = r[a];
    let h, d, c = -1, p = 0;
    for (; p < l.length && (n.lastIndex = p, d = n.exec(l), d !== null); ) p = n.lastIndex, n === b ? d[1] === "!--" ? n = G : d[1] !== void 0 ? n = Q : d[2] !== void 0 ? (ht.test(d[2]) && (s = RegExp("</" + d[2], "g")), n = _) : d[3] !== void 0 && (n = _) : n === _ ? d[0] === ">" ? (n = s ?? b, c = -1) : d[1] === void 0 ? c = -2 : (c = n.lastIndex - d[2].length, h = d[1], n = d[3] === void 0 ? _ : d[3] === '"' ? Y : X) : n === Y || n === X ? n = _ : n === G || n === Q ? n = b : (n = _, s = void 0);
    const $ = n === _ && r[a + 1].startsWith("/>") ? " " : "";
    o += n === b ? l + At : c >= 0 ? (i.push(h), l.slice(0, c) + D + l.slice(c) + v + $) : l + v + (c === -2 ? (i.push(void 0), a) : $);
  }
      ...
      if (s.nodeType === 1) {
        if (s.hasAttributes()) {
          ...
          for (const p of s.getAttributeNames()) if (p.endsWith(D) || p.startsWith(v)) {
            const $ = d[n++];
            if (c.push(p), $ !== void 0) {
              const ct = s.getAttribute($.toLowerCase() + D).split(v), U = /([.?@])?(.*)/.exec($);
              l.push({ type: 1, index: o, name: U[2], strings: ct, ctor: U[1] === "." ? bt : U[1] === "?" ? Ct : U[1] === "@" ? wt : O });
        ...
        if (ht.test(s.tagName)) {
          ...
          if (p > 0) {
            ...
            for (let $ = 0; $ < p; $++) s.append(c[$], C()), f.nextNode(), l.push({ type: 2, index: ++o });
            s.append(c[p], C());
          }
        }
        ...
        let c = -1;
        for (; (c = s.data.indexOf(v, c + 1)) !== -1; ) l.push({ type: 7, index: o }), c += v.length - 1;
      }
      o++;
    }
  }
...
class P {
  ...
  _$AI(t, e = this) {
    t = E(this, t, e), w(t) ? t === u || t == null || t === "" ? (this._$AH !== u && this._$AR(), this._$AH = u) : t !== this._$AH && t !== m && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : gt(t) ? this.T(t) : this._(t);
  }
  k(t) {
...
class O {
  ...
  _$AI(t, e = this, i, s) {
    ...
    if (o === void 0) t = E(this, t, e, 0), n = !w(t) || t !== this._$AH && t !== m, n && (this._$AH = t);
      ...
      const a = t;
      let l, h;
      for (t = o[0], l = 0; l < o.length - 1; l++) h = E(this, a[i + l], e, l), h === m && (h = this._$AH[l]), n || (n = !w(h) || h !== this._$AH[l]), h === u ? t = u : t !== u && (t += (h ?? "") + o[l + 1]), this._$AH[l] = h;
    }
    n && !s && this.j(t);
  }
  j(t) {
...
class wt extends O {
  ...
  _$AI(t, e = this) {
    var i;
    if ((t = (i = E(this, t, e, 0)) !== null && i !== void 0 ? i : u) === m) return;
...
it == null || it(x, P), ((k = T.litHtmlVersions) !== null && k !== void 0 ? k : T.litHtmlVersions = []).push("2.8.0");
const Pt = (r, t, e) => {
  var i, s;
...
class dt extends S {
  ...
  constructor() {
    super(), this.value = "", this.label = "Enter text", this.required = !1, this.error = "";
  }
  render() {
    return tt`
  ...
  onInput(t) {
    this.value = t.target.value, this.validate(), this.dispatchEvent(new CustomEvent("value-changed", {
      detail: this.value,
      bubbles: !0,
      composed: !0
    }));
...
customElements.define("nintex-textfield", dt);
export {
  dt as NintexTextField
};
